...
awful.rules.rules = {
    ...
    -- Floating clients.
    { rule_any = {
	-- makes dialogues float and have title bars
	type = {
	  "dialog"
	},
        instance = {
    ...
    -- *I disabled this so only floating windows get titlebars ^^^* Add titlebars to normal clients and dialogs
